...
from src.funcs.scraping_headlins import scrape_reuters_nikkei_quote
from src.funcs.rank_headlines import rank_headlines_with_openai
...
def main():
    ...
    # # --- 4. Display Current Positions vs Latest CSV Price ---
    # print("\n--- Step 4: Getting Current Positions and Comparing with Latest CSV Price ---")
    ...
    # --- 6. Get and Format Summaries of Top News Articles ---
    print("\n--- Step 6: Getting and Formatting Summaries of Top News Articles ---")
    
    # 6-1. 関数を呼び出し、要約文のリストを取得
    summaries_list = get_and_summarize_top_articles(top_n=5)

    # 6-2. AIに渡すために、取得したリストを整形済みの単一文字列に変換
